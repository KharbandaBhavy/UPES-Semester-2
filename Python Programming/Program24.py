...
def submitt():   
    ...
    labe=Label(window,text="User name is : "+pname,font = "Arial").place(x=300,y=500)
    lab=Label(window,text ="The average marks is : "+str(avg),font = "Arial").place(x=300,y=550)
...
button = Button(window, text='Submit details', bd=10,width=25,bg = "blue",fg ="white", border=5,command=submitt).place(x=300,y=600)
