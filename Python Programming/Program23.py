...
b1 = Button(root, text='Click Me',border = 5, bg = "blue",fg ="white",width=10,command=click).place(x=200,y=300)
b2 = Button(root, text='Stop',border=5,width=10, bg ="black", fg="white", command=root.destroy).place(x=200,y=350)
b3 = Button(root, text='Submit',border =5, bg = "blue",fg ="white", width = 10, command=username).place(x=200,y=130)
